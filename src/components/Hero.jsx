    ...
    <div id='Home' name="Home" className='w-full min-h-screen bg-gray-950 text-white flex flex-col md:flex-row pt-[65px]'>
      ...
      <div className='w-full p-8 md:p-12 md:w-1/2 order-1 md:order-2 flex justify-center items-center'>
        <div className="relative group">
          {/* Gradient Ring */}
          <div className="absolute -inset-1 rounded-full bg-gradient-to-tr from-sky-400 via-sky-400 to-sky-400 blur-sm opacity-90 group-hover:opacity-100 transition duration-500 group-hover:scale-105"></div>

          {/* Profile Image */}
          <img
            className='relative w-[350px] md:w-[450px]  rounded-full object-cover transition-transform duration-500 group-hover:scale-105'
              ...
              <ul className='mt-2 flex justify-center md:justify-start space-x-3'>
                <li className='text-2xl p-2 border border-white rounded-full hover:scale-110 duration-200 cursor-pointer'>
                  <a
                    ...
                    className='text-white' // optional styling
                  >
                    <FaWhatsapp />
                  </a>
                </li>
