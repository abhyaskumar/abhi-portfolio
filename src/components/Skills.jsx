...
const Skills = () => {
    return (
        <div id="Skills" name="Skills" className="min-h-screen  bg-gray-900 text-white dark:bg-white dark:text-black py-16 px-4 flex flex-col items-center justify-center">
            {/* Heading */}
